...
int
DSRC_IncidentResponseEquipment_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
DSRC_IncidentResponseEquipment_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
DSRC_IncidentResponseEquipment_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	DSRC_IncidentResponseEquipment_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
DSRC_IncidentResponseEquipment_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
DSRC_IncidentResponseEquipment_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DSRC_IncidentResponseEquipment_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
DSRC_IncidentResponseEquipment_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DSRC_IncidentResponseEquipment_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static const asn_INTEGER_enum_map_t asn_MAP_DSRC_IncidentResponseEquipment_value2enum_1[] = {
...
static const unsigned int asn_MAP_DSRC_IncidentResponseEquipment_enum2value_1[] = {
	34,	/* aLS-unit(10060) */
	2,	/* aircraft(9988) */
...
static const asn_INTEGER_specifics_t asn_SPC_DSRC_IncidentResponseEquipment_specs_1 = {
	asn_MAP_DSRC_IncidentResponseEquipment_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_DSRC_IncidentResponseEquipment_enum2value_1,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_DSRC_IncidentResponseEquipment_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
asn_TYPE_descriptor_t asn_DEF_DSRC_IncidentResponseEquipment = {
	"DSRC_IncidentResponseEquipment",
	"DSRC_IncidentResponseEquipment",
	DSRC_IncidentResponseEquipment_free,
	DSRC_IncidentResponseEquipment_print,
	DSRC_IncidentResponseEquipment_constraint,
	DSRC_IncidentResponseEquipment_decode_ber,
	DSRC_IncidentResponseEquipment_encode_der,
	DSRC_IncidentResponseEquipment_decode_xer,
	DSRC_IncidentResponseEquipment_encode_xer,
	0, 0,	/* No UPER support, use "-gen-PER" to enable */
	0, 0,	/* No APER support, use "-gen-PER" to enable */
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_DSRC_IncidentResponseEquipment_tags_1,
	sizeof(asn_DEF_DSRC_IncidentResponseEquipment_tags_1)
		/sizeof(asn_DEF_DSRC_IncidentResponseEquipment_tags_1[0]), /* 1 */
	asn_DEF_DSRC_IncidentResponseEquipment_tags_1,	/* Same as above */
	sizeof(asn_DEF_DSRC_IncidentResponseEquipment_tags_1)
		/sizeof(asn_DEF_DSRC_IncidentResponseEquipment_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	0, 0,	/* Defined elsewhere */
	&asn_SPC_DSRC_IncidentResponseEquipment_specs_1	/* Additional specs */
};
